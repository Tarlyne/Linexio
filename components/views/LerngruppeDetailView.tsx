...
import { PlusIcon, UserPlusIcon, LayoutGridIcon, ClipboardCheckIcon, CalculatorIcon, ShuffleIcon, DocumentDuplicateIcon, InformationCircleIcon, UsersIcon } from '../icons';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 flex-shrink-0">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    {!isArchivedView && (
                        <>
                            <Button variant="secondary" onClick={() => setZuordnenModalOpen(true)}>
