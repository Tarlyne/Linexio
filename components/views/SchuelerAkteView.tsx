...
type AkteTab = 'akte' | 'notizen' | 'leistungen';
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {activeTab === 'leistungen' && (
          <div className="text-center p-12 bg-[var(--color-ui-primary)] rounded-lg border border-[var(--color-border)]">
              <h3 className="text-xl font-semibold text-[var(--color-text-secondary)]">Leistungsübersicht</h3>
              <p className="text-[var(--color-text-tertiary)] mt-2">Dieser Bereich wird in einem zukünftigen Update implementiert.</p>
          </div>
        )}
      </div>
    </div>
